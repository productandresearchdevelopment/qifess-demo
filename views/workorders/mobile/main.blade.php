                    ...
                    items: [
                        {
                            ...
                            prefixText: '',
                            items: [
                                {id: 'filter-activity', name: 'filter-activity', text: 'Activity', items: activities},
                                {id: 'filter-service', name: 'filter-service', text: 'Service', items: services},
                                {id: 'filter-client', name: 'filter-client', text: 'Client', items: clients},
                                {id: 'filter-vendor', name: 'filter-vendor', text: 'Vendor', items: vendors},
                            ]
                        },
                        '-',
                        {
                            ...
                            items: [
                                { text: 'New Update', sort: 'updated_at', dir: 'DESC'},
                                { text: 'Oldest Update', sort: 'updated_at'},
                                { text: 'New Ticket', sort: 'id', dir: 'DESC'},
                                { text: 'Oldest Ticker', sort: 'id' },
                            ],
                        },
                    ],
                }
            ...
            var listView = ai.create('listview', {
                ...
                renderItem: {
                    ...
                    renders: [
                        ...
                        { id: 'fieldtech_name', render: function(rec) { return rec.fieldtech ? rec.fieldtech.name : ''; } },
                        {
                            id: 'client_name',
                            render: function(rec) {
                        ...
                        },
                        {
                            id: 'expire',
                            render: function(rec) {
                                let tpl = '<div class="small-text" style="color: #{color};"><i class="fa fa-hourglass-o"></i> {expire}</div>';
                                let day = dates.shortDay(rec.expire_date);
                                if(day.substr(0,1) == '-') day = {expire: day.substr(1, day.length), color: 'FF0000'}
                                else day = {expire: day, color: '0072ff'}
