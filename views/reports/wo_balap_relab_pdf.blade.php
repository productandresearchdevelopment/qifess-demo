    ...
    <table>
        <tr>
            ...
            <td width="200" align="right" valign="bottom" style="font-size: 11px">
                <div style="background: #f67e00; color: #ffffff; font-size: 15px; padding: 2px 20px"><b>BERITA ACARA LAPANGAN</b></div>
            </td>
        </tr>
    </table>
    ...
    <p>
        ...
        <table style="line-height: 20px;">
            <tr>
                <td width="33%">
                    [
                        @if(in_array($data->activity_id, [1,9])) X @else &nbsp; @endif
                    ] &nbsp; Aktivasi Layanan Baru
                </td>
                <td width="33%">
                    [
                        @if(in_array($data->activity_id, [7])) X @else &nbsp; @endif
                    ] &nbsp; Troubleshooting
                </td>
                <td width="33%">
                    [
                    @if(in_array($data->activity_id, [5])) X @else &nbsp; @endif
                    ] &nbsp; Deaktivasi
                </td>
            </tr>
            <tr>
                <td width="33%">
                    [
                        @if(in_array($data->activity_id, [4])) X @else &nbsp; @endif
                    ] &nbsp; Aktivasi Relokasi
                </td>
                <td width="33%">
                    [
                        @if(in_array($data->activity_id, [])) X @else &nbsp; @endif
                    ] &nbsp; Deaktivasi Relokasi
                </td>
                <td width="33%"></td>
            </tr>
