    ...
    me.init = function() {
      ...
      me.menus = Ext.create('Ext.menu.Menu', {
        items: [
          ...
          @endif
          @if ($user->hasRoute('site.restore') || $user->hasRoute('site.forcedelete'))
            {
              text: 'Trashed',
              iconCls: 'icon-trash',
              menu: {
                items: [
                  @if ($user->hasRoute('site.restore'))
                    {
                      text: 'Restore',
                  ...
                  @if ($user->hasRoute('site.forcedelete'))
                    {
                      text: 'Forever Remove',
                      iconCls: 'icon-remove',
                      handler: function() {
                        ...
                        if (recs.length) {
                          Ext.Msg.confirm('Confirm',
                            'Are you sure you want to permanently remove the selected site?',
                            function(btn) {
                              if (btn === 'yes') {
                                Ext.Ajax.request({
                                  ...
                                  success: function(response) {
                                    ...
                                    Ext.Msg.alert('Success',
                                      'The selected site has been permanently removed.');
                                  },
