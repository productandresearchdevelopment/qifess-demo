                ...
                items : [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            {xtype: 'textareafield', name: 'address', hidden: true, fieldLabel: 'Address',allowBlank:true, flex: 1, height: 30, allowBlank: true},
                            {
                                xtype: 'panel',name: 'file_id',title: 'Attachment File', hidden: true, allowBlank: true,
